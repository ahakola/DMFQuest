...
L.Config_ExtraFeatures_GossipQuests = "Autostart minigames"
L.Config_ExtraFeatures_GossipQuests_Desc = "Start the minigames automatically when speaking to the NPCs, if you are on the related daily quest and have game tokens."
